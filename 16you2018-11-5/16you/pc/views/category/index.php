	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16you']; ?>/pc/css/common.css?v1.1">
...
<div id="content-list">
	<div class="contentbox">
	  ...
	  <div id="hotgame" class="gamecontent" style="background:#fff">
	  	...
	  	<div class="game_list_box" style="margin: 0 1.1rem 0 0.17rem;">
				...
				<li class="game_describe liwidth2">
					<p>
						...
						<?php $labelarr = (!empty($v['label']))?json_decode($v['label'],true):array(); foreach ($labelarr as $lab){
							switch($lab){
								case 0 : echo "<span class='hot'>热门</span>";break;
								case 1 : echo "<span class='boutique'>精品</span>";break;
