...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16you']; ?>/css/gamedetail.css">
	...
	<script type="text/javascript" src="<?php echo yii::$app->params['cdn16you']; ?>/js/swiper(jspacker).js"></script>
	...
	<div id="game-listbox">
	   <div class="gbgbox">
		<div class="gamebackground">
		   ...
		   <img class="backgroundimg" src="<?php echo yii::$app->params['cdn'];?>/game/<?php echo $gameinfo['detailimg'];?>">
		    <?php else:?>
		    <img class="backgroundimg" src="http://cdn16you.zqqgl.com/images/defaultbg.png">
		   <?php endif;?>
		   <div class="blurbg"><img src="<?php echo yii::$app->params['cdn16you'];?>/images/blurd.png"></div>
           <div class="gamelogobox">
           	  <img class="gamelogo" src="<?php echo yii::$app->params['cdn']; ?>/game/<?php echo ($gameinfo['head_img'])?$gameinfo['head_img']:'notset.png';?>">
