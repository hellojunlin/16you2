...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16you']; ?>/pc/css/hot.css">
	    ...
	    <div id="content-list">
			  ...
			  <div id="hotgame" class="gamecontent">
			  	<div class="game_list_box">
					<ul class="game_ul">
						<li class="game_img">
							<img src="<?php echo yii::$app->params['cdn']; ?>/game/<?php echo ($game->head_img)?$game->head_img:'notset.png';?>"> 
						</li> 
