<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16you']; ?>/pc/css/swiper.min.css">
<script type="text/javascript" src="<?php echo yii::$app->params['cdn16you']; ?>/pc/js/swiper(jspacker).js"></script>
  <header class="mt_head" id="head" style="margin-bottom: 45px;display:none;">
	...
	<div class="user-headbox">
		  <div class="u_h">
			<div class="headimg"><img src="<?php echo $user?$user->head_url:yii::$app->params["cdn16you"].'/images/noimg.jpg';?>"></div>
			<div class="infobox">
			   <div class="nametext">
			   		...
			   		<div class="vipbox">
			   			...
			   			<div class="vipgrade">
			   				<img src="<?php echo yii::$app->params['cdn16you']; ?>/images/vips.png">   &nbsp
			...
			<div class="swiper-wrapper">
			   <?php if(is_array($carousel)): foreach ($carousel as $k=>$car):?>
				<div class="swiper-slide carousel-btn"  id="<?php echo  isset($car['url'])?$car['url']:'';?>,<?php echo $k+1;?>">
					<img src="<?php echo yii::$app->params['cdn']; ?>/carousel/<?php echo isset($car['image'])?$car['image']:'';?>">
				</div>
		  ...
		  <div id="hotgame" class="gamecontent">
		    <?php foreach ($hotgame as $k=>$hg):?>
		  	<div class="game_list_box">
				<ul class="game_ul ulwidth"  onclick="window.location.href='/game/detail/<?php echo isset($hg['id'])?$hg['id']:'';?>.html'">
					<li class="game_img liwidth1">
						<img src="<?php echo yii::$app->params['cdn']; ?>/game/<?php echo ($hg['head_img'])?$hg['head_img']:'notset.png';?>">               
					</li>
			...
			<div class="game_list_box">
				<ul class="game_ul ulwidth"  onclick="window.location.href='/game/detail/<?php echo isset($g['id'])?$g['id']:'';?>.html'">
					<li class="game_img liwidth1">
						<img src="<?php echo yii::$app->params['cdn']; ?>/game/<?php echo ($g['head_img'])?$g['head_img']:'notset.png';?>">
					</li>
					<li class="game_describe liwidth2">
						<p class="p_gamename"> 
...
<div id="collectionList" style="display:none">
	...
	<ul id="listdr" style="display: none;"> 
		 <?php foreach ($allgame as $ag):?>
    			<li class="game_list_box_mt show-detail" onclick="window.location.href='/game/detail/<?php echo isset($ag['id'])?$ag['id']:'';?>.html'">
                	<em>
                		<img src="<?php echo yii::$app->params['backend']?>/media/images/game/<?php echo ($ag['head_img'])?$ag['head_img']:'notset.png';?>">
                	</em>
	...
	<script type="text/javascript" src="//pingjs.qq.com/h5/hotclickurl.js?v1.0" name="mtah5hoturl" sid="500504927" hid="ht5ae3047c71711"></script>
	<script type="text/javascript" src="//pingjs.qq.com/h5/hotclick.js?v2.0" name="mtah5hotclick" sid="500504927" hid="5ae3e1933d953"></script>
