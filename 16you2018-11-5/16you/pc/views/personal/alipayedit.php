...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16you']; ?>/pc/css/bind.css?v1.1">
...
<body>
    ...
    <!-- 未绑定状态 -->
	<div id="bindbox" style="margin-top: 0.2rem;<?php if($alipayaccount){echo 'display:none';} ?>">
		<div class="actiontxt">
