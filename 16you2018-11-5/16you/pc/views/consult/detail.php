...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://wx.16you.com/media/css/common.css">
	<link rel="stylesheet" type="text/css" href="http://wx.16you.com/media/css/swiper.min.css">
	<link rel="stylesheet" type="text/css" href="http://wx.16you.com/media/css/notice.css">
	...
	<script type="text/javascript" src="http://wx.16you.com/media/js/swiper.min.js"></script>
	<title><?php echo $model->label; ?></title>
</head>
<body>
	<header class="mt_head">
        <span class="mt_goback" id="mt_goback"><img class="mt-dow" src="/media/images/back.png"></span>
        <h1 class="mt_h">资讯</h1>
    </header>
	<div id="noticebox" style="margin: 0.25rem 0.12rem 1.2rem;">
		<div class="notice-title">
			...
			<div class="n_time">
				<span class="n_img">
					<em><img src="http://wx.16you.com/media/images/meanself.png"></em>
				</span>
