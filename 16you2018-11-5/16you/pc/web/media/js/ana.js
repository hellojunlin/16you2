...
//======================================UUID=============================end
   ...
   var _utmb = $.cookie('_utmb') || '';  
	...
	if ($.cookie('_utmc'+id)) {
		...
		img.src = 'http://countsystem.mxse13.com/httpget/index.html?uid='+_uid+"&source="+_source+"&username="+_username+"&pid="+_pid+"&pname="+_pname+"&ip="+_ip+"&equipment="+_equipment; 
