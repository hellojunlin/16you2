...
use yii;
use common\redpackpay\Wxpay_client_pub;
use common\redpackpay\SDKRuntimeException;
use yii\log\Logger;
class Sendredpack_pub extends Wxpay_client_pub{
	...
	function createXml(){
		...
		//检测必填参数
			...
			$this->parameters["mch_appid"] = $redpackwinfo['appid'];//公众账号ID
			$this->parameters["mchid"] = $redpackwinfo['mch_id'];//商户号
