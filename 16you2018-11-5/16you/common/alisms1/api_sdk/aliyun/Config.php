<?php
namespace common\alisms1\api_sdk\aliyun;
use common\alisms1\api_sdk\aliyun\Autoloader\Autoloader;
use common\alisms1\api_sdk\aliyun\Regions\EndpointConfig;
/*
