                ...
                <div class="panel-body">
                    <form class="form-horizontal adminex-form" id="signupok" enctype="multipart/form-data">
                       ...
                       <label class="col-sm-2 col-sm-2 control-label">角色名称：</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control rolename" name="name">
                        </div>
                       </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control remark" name="description">
                        </div>
                       </div> 
                       <div class="form-group">
									...
									<dd>
							 			<?php foreach ($mp as $m):?>
											<label class="selfinput">
												<input type="checkbox"  name="permission[]" id="user-Character-0-0-0" value="<?php echo $m['route'];?>">
