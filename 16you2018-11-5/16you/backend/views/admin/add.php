                    ...
                    <form class="form-horizontal adminex-form" method="post" id='signupok' enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">账号<span class="must">*</span></label>
                               <div class="col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="账号"  name="username" maxlength="100" required />
                                <span></span>
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="密码"  name="password" maxlength="100" required />
    ...
    $('#submit').click(function(){
	    ...
	    if(username == ''){
	       ...
	       return false;
	    	...
	    	$("input[name='password']").html('密码不能为空').css('color','#900');
		       layer.msg('密码不能为空');
		       return false;
		}else{
	        $(this).next('span').html('');
