	            ...
	            <div class="panel-body">
	                ...
	                <section id="no-more-tables">
	                    ...
	                    <table class="table table-bordered table-striped table-condensed cf">
	                        ...
	                        <tr>
	                          	<th width="95px">日期</th>
	                            <th width="70px">游戏名称</th>
	                            <th width="70px">激活数</th>
	                            <th>当日付费人数</th>
	                            <th>累计2日付费人数</th>
	                            <th>累计3日付费人数</th>
	                            <th>累计4日付费人数</th>
	                         ...
	                         <?php if($data['data']): ?>
	                         	<?php foreach ($data['data'] as $v):?>
	                          	<tr>
	                          		...
	                          		<?php foreach ($v['recycle'] as $v1) {
	                          			echo '<td>'.$v1.'</td>';
	                          		} ?>
	                          		<?php foreach ($v['repay'] as $v1) {
	                          			echo '<td>'.$v1.'</td>';
	                          		} ?>
	                          	</tr>
	                          <?php endforeach; ?>
	                          <?php else: ?>
	                    	<tr><td colspan="17" align="center">暂时没有数据！</td></tr>
	                    	<?php endif; ?> 
	                        </tbody>
	                    </table>
	                </section>
...
$(function() {
	...
	$('#pid').change(function(){
		...
		if(pid!=-1){
			layer.load();
			window.location.href='/recycle/gindex.html?pid='+pid;
		}
	});
