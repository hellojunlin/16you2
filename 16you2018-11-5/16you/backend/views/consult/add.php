...
// window.UEDITOR_HOME_URL = "http://www.wxgame.com/med";
</script>
...
<section class="wrapper">
	<div class="row">
		<div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">添加资讯</header>
                <div class="panel-body">
                    <form class="form-horizontal adminex-form" method="post" action="/consult/create.html" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="标题" data-original-title="标题" name="title" maxlength="16" required />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 icheck ">
                                <div class="radio ">
                                    <input tabindex="3" type="radio" name="label" checked="checked" value="公告">
                                    <label>公告 </label>
                                </div>
                                <div class="radio ">
                                    <input tabindex="3" type="radio" name="label" value="攻略">
                                    <label>攻略 </label>
                                </div>
                                <div class="radio ">
                                    <input tabindex="3" type="radio" name="label" value="活动">
                                    <label>活动 </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" id="editor" style="height:300px" required></textarea>            
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">开始显示时间</label>
                            <div class="col-sm-5">
                                <input class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="开始显示时间" data-original-title="开始显示时间" name="starttime"onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:''})" value="<?php echo date('Y-m-d H:i'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="排序" data-original-title="排序" name="sort" maxlength="5" value="50" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 icheck ">
                                <div class="square-blue">
                                    <div class="radio ">
                                        <div class="iradio_square-blue" style="position: relative;"><input tabindex="3" type="radio" name="type" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" value="1"></div>
                                        <label> 是 </label>
                                    </div>
                                </div>
                                <div class="square-red">
                                    <div class="radio ">
                                        <div class="iradio_square-red" style="position: relative;"><input tabindex="3" type="radio" name="type" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" value="0" checked="checked"></div>
                                        <label> 否 </label>
                                    </div>
                                </div>
                            </div>
