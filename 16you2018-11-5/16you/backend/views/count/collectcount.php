            ...
            <section class="panel">
	            ...
	            <div class="panel-body">
	                ...
	                <section id="no-more-tables">
	                	<div style="color:red;font-weight:bold;display:<?php echo ($managertype!=0)?'blcok':'block';?>;"> 总付费用户数:<?php echo isset($zcount['zuid'])?$zcount['zuid']:0;?>人    总付费金额：<?php echo isset($zcount['zprice'])?$zcount['zprice']:0;?>元  </div>
	                	<?php if ($data['data']): ?>
	                		<div class="span6">
	                    ...
	                    <table class="table table-bordered table-striped table-condensed cf">
	                        ...
	                        <tr>
	                            ...
	                            <th>老用户活跃数
	                                <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="当日老用户激活数">
	                            		<i class="fa fa-question-circle"></i>
	                            	</a>
	                            </th>
	                            <th>付费人数
	                            ...
	                            <th>新增付费人数
	                            	<a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="当日新增用户充值的人数">
	                            		<i class="fa fa-question-circle"></i>
	                            	</a>
	                            </th>
	                            <th>新增付费金额
	                            	<a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="当日新增用户充值的总金额">
	                            		<i class="fa fa-question-circle"></i>
	                            	</a>
	                            </th>
	                            <th>付费次数
	                        ...
	                        <tbody>
	                        	<?php $u=0;$i=0; if($gameorder): ?>
	                        	     <?php if(!$isboolen):?>
				                        	<tr>
				                                ...
				                                <td><?php echo $gameorder['new_user'];?></td>
				                                <td><?php echo $gameorder['old_user'];?></td>
				                                ...
				                                <td><?php echo $gameorder['cuser'];?></td>
				                                <td><?php echo $gameorder['cprice'];?></td>
	                         ...
	                         <?php if($data['data']): ?>
	                           <?php foreach ($data['data'] as $d):?>
	                             <?php if(!$isboolen || $d['count_time']<1525104000):?>
	                                <tr>
		                               	<td><?php echo date('Y-m-d',$d['count_time']);?></td>
		                                <td><?php echo $d['play_user'];?></td>
		                                <td><?php echo $d['new_user'];?></td>
		                                <td><?php echo $d['old_user'];?></td>
		                                ...
		                                <td><?php echo $d['cuser'];?></td>
		                                <td><?php echo $d['cprice'];?></td>
...
$(function() {
	...
	$('#pid').change(function(){
		...
		if(pid!=-1){
			layer.load();
			window.location.href='/count/tocount.html?pid='+pid;
		}
	});
