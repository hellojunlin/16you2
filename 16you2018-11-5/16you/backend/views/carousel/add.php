        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal adminex-form" method="post" enctype="multipart/form-data" action="" id="formdata">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control tooltips" tabindex="3" name="state" id="state">
                                    ...
                                    <option value="2">商城轮播</option>
                                    <option value="3">弃用</option>
                                </select>
                            </div>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="轮播链接" data-original-title="轮播链接" name="url" maxlength="200" required />
                                <!-- <span>http://www.soso.com</span> -->
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span style="color:#e00">*</span> 排序</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="写数字,数字越大,轮播越靠前显示" data-original-title="填写数字,数字越大,轮播越靠前显示" name="sort" oninput="if(value.length>10)value=value.slice(0,10)" value="50"  required /><span></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span style="color:#e00">*</span> 备注</label>
                            <div class="col-sm-5">
                                <input type="url" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="备注" data-original-title="备注" name="remark" maxlength="200"/><span>可以为空</span>
                            </div>
                        </div>
                        <div class="form-group">
