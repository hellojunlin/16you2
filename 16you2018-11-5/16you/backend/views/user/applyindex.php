	                ...
	                <section id="no-more-tables">
	                    ...
	                    <table class="table table-bordered table-striped table-condensed cf">
		                 ...
		                 <!--        	    <button class="btn btn-warning btn-xs" onclick="pwd('<?php echo $v['id']; ?>')"><i class="fa fa-repeat"></i>&nbsp;重置密码</button> -->
		                        	    ...
		                        	    <button class="btn btn-primary btn-xs" id="editcurrency" name="<?php echo $v['id']; ?>" ><i class="fa fa-cny"></i>&nbsp;分发游币</button>
		                        	    <button class="btn  btn-danger btn-xs" id="rebate" name="<?php echo $v['id']; ?>" ><i class="fa fa-money"></i>&nbsp;返利</button>
		                        	    <button class="btn  btn-danger btn-xs" id="updatepid" name="<?php echo $v['id']; ?>" style="display:block;"><i class="fa fa-money"></i>&nbsp;修改平台</button>
		                        	</td>
		                            </tr>
	                        	<?php endforeach;?>
	                    	<?php else: ?>
                 ...
                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  ...
                  <div class="modal-body row">
                    	<div class="form-group">
                         ...
                         <div class="form-group gropbz">
                            <label class="gropcl slowsi col-sm-2 col-sm-2 control-label ">备注</label>
                            <div class="gropcl slowtip col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" id="remarkvalue" maxlength="50" value="" >
                                <span></span>
                            </div>
                        </div> 
                        <div class="form-group">
...
<script>
  ...
  $('body').on('click','#updatepid',function(){
	var name = $(this).attr('name');
	if(confirm('确认修改吗？')){
	      $.ajax({
	    	  url:'/user/updatepid.html',
	          type:'post',
	          dataType:'json',
	          data:{
	               'uid':name,
