    ...
    <div class="col-lg-12">
      	<section class="panel">
	        <header class="panel-heading no-border">
	            <form action="/game/detacount.html">
	              <?php if ($plate): ?>
                        <select class="form-control m-bot15 col-md-3" name="pid" id="pid" style="width:160px;margin-right:10px;">
                        	  <option  value=''>选择平台</option>
                        	 <?php foreach ($plate as $vp):?>
                        	      <option value="<?php echo $vp['id']?>" <?php echo ($pid==$vp['id'])?'selected':'';?>><?php echo $vp['pname'];?></option>
                        	  <?php endforeach;?>
                        </select>
	              <?php endif ?>
	              <input type="hidden" value="<?php echo $gid?>" name="id">
