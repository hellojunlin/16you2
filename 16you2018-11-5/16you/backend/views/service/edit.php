        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" value="<?php echo $newservice->id?>" name="id">
                            <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">选择游戏</label>
                            <div class="col-sm-5">
                                <div class="selectdivbox" style="width:100%;">
                                   <input type="text" class="hidden-input" value="0" name="gid" />
												...
												<ul class="list-unstyled">
												 <?php if($game): ?>
												  <?php foreach ($game as $v):?>
                                						<?php if(isset($v['id'])): ?>
													<li class="filter-item items" data-value="<?php echo $v['id'];?>" <?php if($v['id']==$newservice->gid){echo 'id="selectedgame"';}?>><?php echo $v['name'];?></li>
													 <?php endif; ?>
                               					 <?php endforeach;?>
                               					 <?php endif; ?>
												</ul>
                   ...
                   <!--  
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               <select class="form-control tooltips" tabindex="3" name="gid">
                                <?php foreach ($game as $v):?>
                                <?php if(isset($v['id'])): ?>
                                <option value="<?php echo $v['id'];?>" <?php if($v['id']==$newservice->gid){echo 'selected';} ?>><?php echo  $v['id'].'---'.$v['name'];?></option>
                               <?php endif; ?>
                                <?php endforeach;?>
                               </select>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">区号<span class="must">*</span></label>
                               <div class="col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="区号"  name="service_code" maxlength="100" value="<?php echo $newservice->service_code;?>" required />
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">开服时间<span class="must">*</span></label>
                            <div class="col-sm-5">
                                <input class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="开服时间" data-original-title="开服时间" name="opentime"onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:'',isShowClear:false,isShowToday:false})" value="<?php echo date('Y-m-d H:i',$newservice->open_time);?>"/>
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 icheck ">
                                <div class="square-blue">
                                    <div class="radio ">
                                        <div class="iradio_square-blue" style="position: relative;"><input tabindex="3" type="radio" name="state" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" <?php echo ($newservice->state==1)?'checked':'';?> value="1"></div>
                                        <label> 启用 </label>
                                    </div>
                                </div>
                                <div class="square-red">
                                    <div class="radio ">
                                        <div class="iradio_square-red" style="position: relative;"><input tabindex="3" type="radio" name="state" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" <?php echo ($newservice->state==0)?'checked':'';?> value="0"></div>
                                        <label> 禁用 </label>
                                    </div>
                                </div>
                            </div>
