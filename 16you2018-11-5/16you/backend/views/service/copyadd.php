                   ...
                   <!--  
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">区号<span class="must">*</span></label>
                               <div class="col-sm-5">
                                <input type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="区号"  name="service_code" maxlength="100" value="" required />
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">开服时间<span class="must">*</span></label>
                            <div class="col-sm-5">
                                <input class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="开服时间" data-original-title="开服时间" name="opentime"onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:''})" value="<?php echo date('Y-m-d H:i',$newservice->open_time);?>"/>
                            </div>
                        </div> 
                        <div class="form-group">
