                ...
                <div class="panel-body">
                    <form class="form-horizontal adminex-form" method="post" action="<?=Url::to(['create'])?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group" id="timetype" style="display:none">
                            ...
                            <div class="col-sm-5">
                                <label><input id="start_time" class="form-control tooltips input-text Wdate" type="text"  name="starttime" style="width: 170px;"
                                            onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:''})" placeholder="开始时间"/>
                                           </label> -- 
                                           <label><input id='end_time' class="form-control tooltips input-text Wdate" type="text" name="endtime" style="width: 170px;"
                                            onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:''})" placeholder="结束时间"/></label>
                                    <label>
                            </div>
                        </div>
                        <div class="form-group">
