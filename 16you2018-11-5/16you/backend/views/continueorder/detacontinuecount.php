	                        ...
	                        <tbody>
	                         <?php if($data['data']): ?>
	                         	<?php foreach ($data['data'] as $v):?>
	                          	<tr>
	                          		<td><?php echo isset($v['count_time'])?date('Y-m-d',$v['count_time']):0; //echo $v['count_time'];//?></td>
	                          		<td><?php echo isset($v['gamename'])?$v['gamename']:0;?></td>
...
$(function() {
	...
	$('#pid').change(function(){
		...
		if(pid!=-1){
			layer.load();
			window.location.href='/continueorder/detaindex.html?pid='+pid;
		}
	});
