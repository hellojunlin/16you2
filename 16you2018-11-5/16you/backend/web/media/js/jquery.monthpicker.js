  ...
  $.fn.monthpicker = function(options) {
    ...
    Monthpicker.prototype = {
      ...
      _renderYears: function() {
        ...
        this._yearsSelect = $('<select>').addClass('selectid').html(markup.join('')).appendTo(yearsWrap);
        $(".selectid option[value='"+$('#monthly').val().substr(0,4)+"']").attr("selected",true);
      },
