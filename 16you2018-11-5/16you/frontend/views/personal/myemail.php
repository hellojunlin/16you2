...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16yous']; ?>/css/my_email.css">
	<title>我的邮件</title>
</head>
<body>
	...
	<div class="email_m">
		<div class="mine_email">
			...
			<em class="mineImg">
				<img src="<?php echo yii::$app->params['cdn16yous']; ?>/images/unread.png">
			</em>
			<div class="email_num">
			...
			<ul class="email_list" id="email_list">
				...
				<li class="read" data="<?php echo $v['id']; ?>">
					<em class="readList">
						...
						<img src="/<?php echo yii::$app->params['cdn16yous']; ?>/images/unread.png">
						<?php else: ?>
						<img src="<?php echo yii::$app->params['cdn16yous']; ?>/images/read.png">
						<?php endif; ?>
					</em>
					<div class="em_title">
					...
					<?php if($v['state']==1): ?>
					<div class="em_gift">
						<img src="<?php echo yii::$app->params['cdn16yous']; ?>/images/gift.png">
					</div>
					<?php endif; ?>
				</li>
				<?php };endif; ?>
	...
	$.ajax({
		...
		success:function(data){
			if(data.errorcode==0){
				...
				_obj.find('img:first').attr('src',"<?php echo yii::$app->params['cdn16yous']; ?>/images/read.png");
			}else{
