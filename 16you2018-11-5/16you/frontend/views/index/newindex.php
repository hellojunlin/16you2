    ...
    <div class="content">
        ...
        <section class="hot-game" id="section1">
            <div class="bar-title">
                ...
                <a href="/index/moregame/0.html">更多></a>
            </div>
            <div class="hot-content">
                <ul>
                <?php foreach ($newhotgamearr as $k=>$hg):?>
                    <li>
                        <div class="hot-c-img"  onclick="window.location.href='/index/detail/<?php echo isset($hg['id'])?$hg['id']:'';?>.html'">
        ...
        <section class="new-game" id="section2">
            <div class="bar-title">
                ...
                <a href="/index/moregame/1.html">更多></a>
            </div>
            <div class="new-content">
                <ul>
                  <?php foreach ($newgamearr as $k=>$ng):?>
                    <li>
                        <div class="new-c-msg" onclick="window.location.href='/index/detail/<?php echo isset($ng['id'])?$ng['id']:'';?>.html'">
             ...
             <div class="new-content">
                <ul>
                 <?php foreach ($newrelaxarr as $k=>$rg):?>
                    <li>
                        <div class="new-c-msg" onclick="window.location.href='/index/detail/<?php echo isset($rg['id'])?$rg['id']:'';?>.html'">
                            <div class="nc-msg-titimg">
        ...
        <section class="hots-game" id="section4">
            <div class="bar-title">
                ...
                <a href="/index/moreconsult.html">更多></a>
            </div>
...
<script src="<?php echo yii::$app->params['cdn16you']; ?>/js/newjs/index.js"></script>
