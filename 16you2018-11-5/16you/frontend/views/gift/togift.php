...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo yii::$app->params['cdn16yous']; ?>/css/present.css">
	<title>游戏礼包</title>
</head>
<body>
	<div class="packPage">
					...
					<div class="startGame">
						<div class="vipPresent">
							<div class="list_item_1">
								<div class="pagemain">
									<img src="<?php echo yii::$app->params['cdns']; ?>/game/<?php echo $v['game_image']; ?>" alt="">
								</div>
	...
	<div class="popup_bg gameImgSt" id="pack-info-dialog" >
		<div class="receive_success" style=" margin-top: -202px;">	<div class="get1_img">
			<img src="<?php echo yii::$app->params['cdn16yous']; ?>/images/libao1.png">
		</div>
		<em class="close">
		...
		<div class="novice_bag_num">
			...
			<h2>
				<img src="<?php echo yii::$app->params['cdn16yous']; ?>/images/up_icon.png">长按上方复制激活码
			</h2>
...
<script>
	...
	//查看更多礼包
	$(".gameImgSt1").on('click',".list_item_3",function(){
		var _obj = $(this);
		...
		$.ajax({
			...
			type:'post',
			data:{'data':_obj.attr('name'),'gamename':sgamename},
			dataType:'json',
