  ...
  wx.ready(function () {
    // 在这里调用 API
	  ...
	  wx.onMenuShareTimeline({//voteinfo
	    title:'16游新年活动', // 分享标题
	    link:  "<?php echo yii::$app->params['frontends'].'/lucked/index.html?token='.rand(100000000,999999999).yii::$app->session['user']->id;?>",// 分享链接
...
<body>
	<div class="luckbigbox">
	   ...
	   <div class="header">
			<span class="attionTip">活动时间：2月16号-3月2号，为期15天</span>
		</div>
		<!--整点秒抢-->
		<div class="seckill">
			<div class="sectitle">
...
<!-- 					<p class="sectxtTwo">幸运大转盘</p> -->
	...
	<script type="text/javascript" src="<?php echo yii::$app->params['cdn16yous']; ?>/js/lottery.js"></script>
    ...
    $('#synthetic').click(function(){
    	if(state){
	    	$.ajax({
	    		url:'/lucked/warehousesynthesis.html',
	      		type:'post',
	      		dataType:'json',
	      		success:function(data){
	      			if(data.errorcode == 0){
