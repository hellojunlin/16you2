		...
		<ul id="listdr_mt" style="margin-bottom: 17%;"> 
			...
			<li class="game_list_box_mt show-detail">
				...
				<p>
					...
					<span class="col_4mt_dr colcommon_mt"><b class="colNum"><?php echo $sgame['gamenum']+($days*100)?></b>人玩过</span>
				</p>
               ...
               window.addEventListener('popstate', function(e) {    
            	   	...
            	   	// $("#smallgame").css('display','block');
						if(document.referrer==0){
							window.location.href="<?php echo yii::$app->params['frontends'];?>/sgameindex/index.html";
						}else{
							// window.history.back();
