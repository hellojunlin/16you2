...
class ConsultController extends BaseController
{
    ...
    public function actionGetconsult(){
        ...
        $consult_boolean = (isset($_POST['consult_boolean']))?Helper::filtdata(yii::$app->request->post('consult_boolean',1)):2;
        $pageSize = 20;
        $time = time();
    ...
    public function actionDetail(){
        ...
        if($id){
            ...
            $game = Game::find()->where(['!=','state',0])->orderBy('sort desc')->one();//底部一个游戏
