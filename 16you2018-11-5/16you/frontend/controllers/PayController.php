...
class PayController extends BaseController{
	...
	public function actionGetdata(){
		if(Yii::$app->request->isAjax){
			...
			if(!$out_trade_no||!$product_id || $total_fee===false ||$sign===false ||!$user){
			...
			$jsApiObj = $wxpayutil->pay($user->openid,$order->transaction_id,$total_fee/100,$body,$attach,$product_id);
