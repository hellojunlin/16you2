...
(function($) {
    $.fn.date = function(options, Ycallback, Ncallback) {
        ...
        var year1 = nowdate.getYear();
        var month1 = nowdate.getMonth() + 1;
        var strDate1 = nowdate.getDate();
        $.fn.date.defaultOptions = {
            // var myDate_t = new Date();    
            // var year_t = myDate_t.getFullYear();
            // var month_t = myDate.getMonth() + 1;
            // var strDate_t = myDate.getDate();
            beginyear: 1900, //日期--年--份开始
            endyear: 2017, //日期--年--份结束
            beginmonth: 1, //日期--月--份结束
            endmonth: month1, //日期--月--份结束
            beginday: 1, //日期--日--份结束
            endday: strDate1, //日期--日--份结束
            beginhour: 1,
            endhour: 12,
            beginminute: 00,
            endminute: 59,
        ...
        function init_iScrll() {
            ...
            /*var strD = $("#daywrapper ul li:eq(" + indexD + ")").html().substr(0, $("#daywrapper ul li:eq(" + indexD + ")").html().length - 1);*/
            ...
            dayScroll = new iScroll("daywrapper", {
                ...
                onScrollEnd: function() {
                    indexD = (this.y / 40) * (-1) + 1;
                     indexD = strDate1;//dre
                    // opts.endday = checkdays(strY, strM,strD);
                    // $("#daywrapper ul").html(createDAY_UL());
                    // dayScroll.refresh();
                }
            });
